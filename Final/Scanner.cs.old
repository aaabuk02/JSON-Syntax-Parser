...
public class Scanner {
	...
	static Scanner() {
		...
		for (int i = 48; i <= 48; ++i) start[i] = 2;
		for (int i = 49; i <= 57; ++i) start[i] = 8;
		for (int i = 34; i <= 34; ++i) start[i] = 9;
		start[45] = 1; 
		start[116] = 11; 
		start[102] = 14; 
		start[110] = 19; 
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 1:
				if (ch == '0') {AddCh(); goto case 2;}
				else if (ch >= '1' && ch <= '9') {AddCh(); goto case 8;}
				else {goto case 0;}
			case 2:
			...
			case 9:
				...
				else if (ch <= '!' || ch >= '#' && ch <= '[' || ch >= ']' && ch <= 65535) {AddCh(); goto case 9;}
			...
			case 12:
				if (ch == 'u') {AddCh(); goto case 13;}
				else {goto case 0;}
			case 13:
				if (ch == 'e') {AddCh(); goto case 18;}
				else {goto case 0;}
			case 14:
